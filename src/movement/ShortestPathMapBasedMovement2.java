 ...
 */
public class ShortestPathMapBasedMovement2 extends MapBasedMovement implements 
	SwitchableMovement {
	 ...
	 */
	public ShortestPathMapBasedMovement2(Settings settings) {
		super(settings);
	 ...
	 * the new object to 
	 */
	protected ShortestPathMapBasedMovement2(ShortestPathMapBasedMovement2 mbm) {
		super(mbm);
